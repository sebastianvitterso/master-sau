...
const FROM_PATH = path.resolve('../sauebilder/Lønset/RGB/')
const LABELS_PATH = path.resolve('../sauebilder/Lønset/labels/')
const TO_PATH = path.resolve('../sauebilder/Lønset/RGB_unlabeled/')
