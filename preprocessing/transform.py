...
if __name__ == "__main__":
    transform_data(use_ir=True, partition=False, keep_empty=False)
    transform_data(use_ir=False, partition=True, keep_empty=False)
    transform_data(use_ir=True, partition=True, keep_empty=False)
