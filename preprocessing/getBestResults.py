...
for run_index in range(10):
    filename = f'../yolov5/runs/train/exp{(run_index + 1):02}/results.csv'
    ...
    with open(filename, newline='') as csvfile:
        ...
        print(f'{(run_index + 1):02}', epoch_count, max_map_05[0], max_map_05[1], max_map_05_095[0], max_map_05_095[1], max_precision[0], max_precision[1], max_recall[0], max_recall[1])
